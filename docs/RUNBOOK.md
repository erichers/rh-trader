...
The hard stop, gain-lock floor (+1.5%), and trail run first. A Jev hold or tighten cannot clear a stop or the gain-lock. Short dated contracts (0 to 3 DTE) are checked about every 5 minutes, 4 to 14 DTE about every 20 minutes, 15 to 179 DTE about every hour, and LEAPS about every 4 hours. A fresh decision inside that window does not call TypeSafe again. The $5 budget still applies. The Bots list shows each bot's Jev scopes (default off) and links here.
