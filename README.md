...
| --- | --- | --- | --- | --- |
| `chat` | Ask AI text-to-SQL, assistant | Muse Spark `muse-spark-1.3` | Groq 120b / 27b / 20b, NVIDIA, Kimi, Anthropic | Option A: Muse-first Ask AI; Groq stays the fast fallback |
