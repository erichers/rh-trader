...
export const DOCS: Record<string, string> = {
  ...
  providers: 'Ask AI chat leads Muse (Standard muse-spark-1.3), then Groq 120b and the rest. News triage stays Groq-first. Research, review, and ideas lead with NVIDIA, then Groq, with Muse as backup. Watch, performance, and agent lead with Muse. Kimi is backup. Anthropic stays on the chain but the key may be invalid.',
