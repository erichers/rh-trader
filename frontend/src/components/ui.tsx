...
export const DOCS: Record<string, string> = {
  ...
  providers: 'Ask AI chat leads Muse (Standard muse-spark-1.3), then Groq 120b, then NVIDIA. News triage stays Groq-first. Research, review, and ideas lead with NVIDIA, then Groq, with Muse as backup. Watch, performance, and agent lead with Muse. Kimi is backup. Anthropic and Local stay in the cascade but are hidden from chips and probes unless they are live (set ANTHROPIC_ENABLE=1 or LOCAL_BASE_URL + LOCAL_MODEL).',
