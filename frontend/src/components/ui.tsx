...
export const DOCS: Record<string, string> = {
  ...
  muse: 'Muse Spark (Meta Model API, PAYG Standard muse-spark-1.3) is the first-class ops model. It leads watch, performance, and agent tasks. Green lamp means a key is set and the last /models probe succeeded. The progress panel shows the current call, last watch cycle, last news pass, and sanitized errors. No secrets in that JSON.',
  providers: 'Chat and news triage lead with Groq. Research, review, and ideas lead with NVIDIA, then Groq, with Muse as backup. Watch, performance, and agent lead with Muse. Kimi is backup. Anthropic stays on the chain but the key may be invalid.',
